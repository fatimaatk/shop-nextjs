...
import Civility from "../component/checkout/Civility";
import Contact from "../component/checkout/Contact";
import OrderCheckout from "../component/checkout/OrderCheckout";
import OtherAdress from "../component/checkout/OtherAdress";
import OtherCivility from "../component/checkout/OtherCivility";
import Notes from "../component/checkout/Notes";
  ...
  return (
    <div>
      ...
      <Modal show={result}>
        ...
        <Modal.Footer>
          <Link href={"/"}>Redirect to the home page.</Link>
        </Modal.Footer>
      </Modal>
